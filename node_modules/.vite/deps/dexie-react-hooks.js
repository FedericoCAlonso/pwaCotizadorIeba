...
import { Dexie, liveQuery } from "./dexie.js";
...
function useObservable(observableFactory, arg2, arg3) {
	...
	var monitor = import_react.useRef({
		hasResult: false,
		result: defaultResult,
		error: null
	});
	var _a = import_react.useReducer(function(x) {
		return x + 1;
	}, 0);
	_a[0];
	var triggerUpdate = _a[1];
	var observable = import_react.useMemo(function() {
