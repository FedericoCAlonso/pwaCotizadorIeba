    ...
    <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-4 space-y-3 shadow-2xs">
              <div className="flex items-center justify-between">
                ...
                {selectedCliente.cuit && (
                  <span className="text-xs font-mono font-semibold bg-surface-container-highest px-2 py-0.5 rounded-lg text-on-surface-variant">
                    CUIT/DNI: {selectedCliente.cuit}
                  </span>
                )}
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-on-surface">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full bg-surface-container-highest border border-outline-variant/30 rounded-2xl px-4 py-2.5 text-xs sm:text-sm font-semibold text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/50 min-h-[44px] transition-shadow shadow-2xs"
            >
              {tiposFactura.map((tf) => (
          ...
          <div>
            ...
            <div className="relative">
              <NumericInput
                ...
                min={1}
                max={365}
                className="w-full bg-surface-container-highest border border-outline-variant/30 rounded-2xl px-4 py-2.5 text-xs sm:text-sm text-on-surface font-mono font-bold focus:outline-none focus:ring-2 focus:ring-primary/50 min-h-[44px] transition-shadow shadow-2xs"
              />
              <Calendar className="w-4 h-4 text-on-surface-variant absolute right-3.5 top-3 pointer-events-none" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-container-low rounded-3xl p-4 sm:p-6 border border-outline-variant/20 shadow-xs space-y-4">
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3 cursor-pointer text-xs sm:text-sm font-semibold text-on-surface select-none">
            <input
              type="checkbox"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-container-highest border border-outline-variant/30 rounded-2xl px-4 py-2.5 text-xs sm:text-sm text-on-surface font-semibold focus:outline-none focus:ring-2 focus:ring-primary/50 min-h-[44px]"
              ...
              <div>
                ...
                <NumericInput
                  ...
                  min={0}
                  decimals={2}
                  className="w-full bg-surface-container-highest border border-outline-variant/30 rounded-2xl px-4 py-2.5 text-xs sm:text-sm text-on-surface font-mono font-bold focus:outline-none focus:ring-2 focus:ring-primary/50 min-h-[44px]"
                />
              </div>
            </div>
          )}
      ...
      <div className="flex justify-end pt-2">
        <button
          type="button"
          onClick={onNext}
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-on-primary rounded-2xl text-xs sm:text-sm font-bold shadow-md hover:bg-primary/90 transition-all cursor-pointer"
        >
