...
export const PartidasTab: React.FC<PartidasTabProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-surface-container-low rounded-3xl p-4 sm:p-5 border border-outline-variant/20 shadow-xs flex flex-wrap items-center justify-between gap-3">
        <div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-primary hover:bg-primary/90 text-on-primary rounded-xl sm:rounded-2xl text-xs sm:text-sm font-bold transition-all shadow-xs min-h-[40px] cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-surface-container-highest hover:bg-outline-variant/30 text-on-surface rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold transition-all border border-outline-variant/30 min-h-[40px] cursor-pointer"
          ...
          return (
            <div className="p-4 bg-amber-500/15 border border-amber-500/30 rounded-2xl text-amber-700 dark:text-amber-300 flex items-start gap-3 shadow-xs">
              ...
              <div className="text-xs space-y-1">
                <p className="font-bold text-sm">Advertencia de Margen Bajo ({netMarginPct.toFixed(1)}%)</p>
                <p>
        ...
        <div className="text-center py-16 px-4 border-2 border-dashed border-outline-variant/40 rounded-3xl bg-surface-container-low space-y-4">
          ...
          <div className="pt-2 flex items-center justify-center gap-3 flex-wrap">
            <button
              type="button"
              onClick={() => onOpenItemPicker(undefined)}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-on-primary rounded-2xl text-xs sm:text-sm font-bold shadow-xs hover:bg-primary/90 transition-all cursor-pointer"
            >
              <Plus className="w-4 h-4" />
            ...
            <button
              type="button"
              onClick={() => onAddDirectItem(undefined)}
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-surface-container-highest text-on-surface rounded-2xl text-xs sm:text-sm font-semibold hover:bg-outline-variant/30 transition-all border border-outline-variant/30 cursor-pointer"
            >
            ...
            <div className="space-y-5">
              {capitulos.map((cap) => {
                ...
                return (
                  <div
                    key={cap.id}
                    className="bg-surface-container/50 border border-outline-variant/30 rounded-3xl p-4 sm:p-5 space-y-3"
                  >
                    {/* Chapter Header */}
                    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-outline-variant/20 pb-3">
                      <div className="flex items-center gap-2 flex-1 min-w-[180px]">
                        ...
                        <input
                          ...
                          className="bg-transparent border-none p-0 text-sm sm:text-base font-bold text-on-surface focus:ring-0 w-full"
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button
                          ...
                          className="p-1.5 text-on-surface-variant hover:text-error rounded-full transition-colors cursor-pointer"
                    ...
                    <div className="pt-2 border-t border-outline-variant/15 flex items-center justify-end">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary text-xs font-bold transition-colors shadow-2xs cursor-pointer"
                      >
