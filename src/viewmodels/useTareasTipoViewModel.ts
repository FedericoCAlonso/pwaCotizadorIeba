  ...
  const handleSaveTarea = async (tareaData: Partial<TareaTipo>) => {
    ...
    if (editingTarea) {
      const updated: TareaTipo = {
        ...
        naturaleza: tareaData.naturaleza || editingTarea.naturaleza || 'instalacion',
        honorarioBase: tareaData.honorarioBase !== undefined ? tareaData.honorarioBase : editingTarea.honorarioBase,
        formulaHonorarios: tareaData.formulaHonorarios !== undefined ? tareaData.formulaHonorarios : editingTarea.formulaHonorarios,
        costoServicioDirecto: tareaData.costoServicioDirecto !== undefined ? tareaData.costoServicioDirecto : editingTarea.costoServicioDirecto,
        ...
        horasSetupTotal: tareaData.horasSetupTotal !== undefined ? tareaData.horasSetupTotal : editingTarea.horasSetupTotal,
        cuadrillaRecomendada: tareaData.cuadrillaRecomendada || editingTarea.cuadrillaRecomendada,
        updatedAt: now
      };
      ...
      const newTarea: TareaTipo = {
        ...
        naturaleza: tareaData.naturaleza || 'instalacion',
        honorarioBase: tareaData.honorarioBase || 0,
        formulaHonorarios: tareaData.formulaHonorarios || '',
        costoServicioDirecto: tareaData.costoServicioDirecto || 0,
        ...
        esParametrico: tareaData.esParametrico ?? Boolean(tareaData.parametros?.length || tareaData.variables?.length || tareaData.formulaHonorarios),
        ...
        horasSetupTotal: tareaData.horasSetupTotal ?? 1.0,
        cuadrillaRecomendada: tareaData.cuadrillaRecomendada || { oficiales: 1, ayudantes: 1 },
        frecuenciaUso: 0,
        createdAt: now,
        updatedAt: now,
        deleted: false
